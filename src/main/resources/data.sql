...
values ('93c14646-add9-4692-8308-d3e37c2eb571',
        ...
        3.5, 15, 'smart phones', '', null);
insert into product
values ('f06c86b0-3598-4242-bf3e-0b28c3ed0a7e', 'ซัมซุงฮีโร่ B109H รองรับ 3G/4G Samsung Hero โทรศัพท์ปุ่มกด ทนทาน เมนู/แป้นพิมพ์ไทย', 599.00, 0, 20,
        ...
        5, 30, 'smart phones', '', null);
insert into product
values ('43b2c802-dd6e-47df-99e4-511dad7bb9aa', 'Original Unlocked for iPhone 6s Plus 5.5 inch 2GB RAM 16GB/32GB/64GB/128GB WCDMA 4G LTE（รองรับภาษาไทย',
        ...
        'smart phones', '', DATE(NOW()) + INTERVAL 1 MONTH);

-- user
insert into user
values ('8d9470e7-979b-4dee-b622-8d40cd55afaf', 'ชลกร ปุนภพถาวร', '565/1 ถนนพุทธมณฑลสาย1 บางด้วน', 'ภาษีเจริญ', 'กรุงเทพมหานคร', '10160', '0614479979', 'is200043', '');

insert into user_item
values ('8d9470e7-979b-4dee-b622-8d40cd55afaf', '43b2c802-dd6e-47df-99e4-511dad7bb9aa', 2, 4880.00, '{"color": "GREY", "size": "64GB"}');
