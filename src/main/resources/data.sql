...
insert into product
values (UUID(), 'ซัมซุงฮีโร่ B109H รองรับ 3G/4G Samsung Hero โทรศัพท์ปุ่มกด ทนทาน เมนู/แป้นพิมพ์ไทย', 599.00, 0, 20,
...
insert into product
values (UUID(), 'Original Unlocked for iPhone 6s Plus 5.5 inch 2GB RAM 16GB/32GB/64GB/128GB WCDMA 4G LTE（รองรับภาษาไทย',
...
-- user
insert into user
values (UUID(), 'ชลกร ปุนภพถาวร', '565/1 ถนนพุทธมณฑลสาย1 บางด้วน', 'ภาษีเจริญ', 'กรุงเทพมหานคร', '10160', '0614479979');
